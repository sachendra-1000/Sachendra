  ...
  const creations = [
    {
      ...
      description: 'An AI-powered platform that adapts to user behavior in real-time.',
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex max-w-6xl flex-col gap-12 px-6">
        ...
        <div className="grid gap-8 md:grid-cols-2">
          {creations.map((creation, index) => {
            ...
            return (
              <article
                key={creation.title}
                className={`group relative cursor-pointer overflow-hidden rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl transition-all duration-700 ease-out ${
              ...
              >
                ...
                <div className="relative aspect-[16/10] overflow-hidden">
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${creation.gradient} transition-transform duration-700 ${
        ...
        >
          <button className="group relative inline-flex items-center gap-2 overflow-hidden rounded-full px-8 py-3 text-sm font-medium text-white">
